...
return [
    ...
    */
    ...
    'embed_block_id' => \env('SHOPIFY_ICONITO_APP_EXTENSION_ID', ''),

    'embed_block_name' => \env('SHOPIFY_ICONITO_APP_EXTENSION_NAME', 'iconito_block'),

    /*
     * App handle used in theme block URLs (shopify://apps/{handle}/blocks/...).
     * Set via SHOPIFY_THEME_EXTENSION_APP_HANDLE in .env (must match Shopify Partners).
     */
    'theme_extension_app_handle' => \env('SHOPIFY_THEME_EXTENSION_APP_HANDLE', ''),

    /*
     * Optional alternate block handle (e.g. iconito_script). Leave empty if not used.
     */
    'theme_extension_block_name_alt' => \env('SHOPIFY_THEME_EXTENSION_BLOCK_NAME_ALT', ''),
    ...
    */
    ...
    'has_test_plan' => \env('SHOPIFY_HAS_TEST_PLAN', false),
    /*
    |--------------------------------------------------------------------------
    | Shopify API Version
    |--------------------------------------------------------------------------
    ...
    */
    ...
    'webhooks' => [
        [
            ...
            'address' => \env('SHOPIFY_WEBHOOK_URL', 'https://iconito-v2.test') . '/webhook/app-uninstalled',
        ], [
            'topic' => 'PRODUCTS_CREATE',
            'address' => \env('SHOPIFY_WEBHOOK_URL', 'https://iconito-v2.test') . '/webhook/products-create',
        ], [
            'topic' => 'PRODUCTS_UPDATE',
            'address' => \env('SHOPIFY_WEBHOOK_URL', 'https://iconito-v2.test') . '/webhook/products-update',
        ], [
            'topic' => 'PRODUCTS_DELETE',
            'address' => \env('SHOPIFY_WEBHOOK_URL', 'https://iconito-v2.test') . '/webhook/products-delete',
        ], [
            'topic' => 'COLLECTIONS_CREATE',
            'address' => \env('SHOPIFY_WEBHOOK_URL', 'https://iconito-v2.test') . '/webhook/collections-create',
        ], [
            'topic' => 'COLLECTIONS_UPDATE',
            'address' => \env('SHOPIFY_WEBHOOK_URL', 'https://iconito-v2.test') . '/webhook/collections-update',
        ], [
            'topic' => 'COLLECTIONS_DELETE',
            'address' => \env('SHOPIFY_WEBHOOK_URL', 'https://iconito-v2.test') . '/webhook/collections-delete',
        ], [
            'topic' => 'THEMES_UPDATE',
            'address' => \env('SHOPIFY_WEBHOOK_URL', 'https://iconito-v2.test') . '/webhook/themes-update',
        ], [
            'topic' => 'THEMES_PUBLISH',
            'address' => \env('SHOPIFY_WEBHOOK_URL', 'https://iconito-v2.test') . '/webhook/themes-publish',
        ], [
            'topic' => 'APP_SUBSCRIPTIONS_UPDATE',
            'address' => \env('SHOPIFY_WEBHOOK_URL', 'https://iconito-v2.test') . '/webhook/app-subscriptions-update',
        ],
    ],
